...
| 스키마 정본 | **ERD v1.4** (김락원 · 2026-08-25). PRD와의 경계는 §6.11 · 매핑은 §6.12 |
...
## 8.1 카테고리 6종 `DECIDED` (D-12)

| 코드 | 표시명 | 포함 예시 |
|---|---|---|
| `WEB_DEVELOPMENT` | 웹 개발 | 웹사이트 · 웹 서비스 · 관리자 페이지 · 쇼핑몰 |
| `APP_DEVELOPMENT` | 앱 개발 | iOS · Android · 크로스플랫폼 앱 |
...
| P04 | 배달앱 MVP 개발 | 앱 개발 | `OPEN` | `NONE` | 0건 | **P01의 추천 대상** (같은 기술 겹침) |
...
| P10 | 커머스 앱 리뉴얼 | 앱 개발 | `CLOSED` | **`IN_PROGRESS`** | 1건 수락 | **작업 중 · 납품 시연** |
...
> **구현을 막는 항목은 없습니다.** 세 문서(PRD v6.4 · ERD v1.4 · 네이밍 컨벤션 v1.4)가 같은 값을 가리킵니다.
>
