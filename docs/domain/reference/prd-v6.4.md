...
RFP §3.3.1. 알림은 전부 **오민혁이 만듭니다** (CR-0001, 2026-09-07 — 사용자 요청으로 최윤석에서 인수).
...
| — | 홈/랜딩 | — | **유동우** (CR-0011, 2026-09-03 — 실제 작업 상태에 맞춰 오민혁→유동우로 정정) |
| — | 로그인 · 프로필 | — | 오민혁 |
...
| §3.3.1 | 필수 알림 5종 | 오민혁 | **마감 알림은 project-management가 촉발** (§5.6, CR-0001 — 2026-09-07 오민혁 인수) | ✅ 계약 정의 |
| §3.3.2 | 미확인 알림 표시 · 읽음 처리 | 오민혁 | — | ➖ |
...
| `isBookmarked` | ⚠️ **실제 계약(`app/`)에는 없음** — CR-0008(2026-09-02)로 뺐다. 대신 화면이 `GET /api/v1/bookmarks/ids`로 직접 대조한다. 이 문서는 참고용으로 남겨둔다 |
