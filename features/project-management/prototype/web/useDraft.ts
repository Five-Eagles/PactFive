 ...
 * 를 충족하기 위한 것이다 (CR-0006 결함 3).
 *
 * ## 왜 브라우저인가
 *
 * 규칙 1 이 **"서버에는 마지막 단계에서 한 번만 저장한다. 중간 단계를 서버에 임시
...
/** 테스트용. 브라우저 없이 같은 동작을 확인한다 */
export function createMemoryDraftStore(): DraftStore & { dump(): Record<string, string> } {
