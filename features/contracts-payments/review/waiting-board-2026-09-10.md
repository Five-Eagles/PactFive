# 대기 현황판 — 2026-09-10 (2026-09-14 reviews 세션)
...
| 갱신 | 2026-09-14 — R-06 userExists DB 배선 |
...
| 4 | 리뷰 태그 방향 (화면) | R4. `/me`·myDirection 반영됨 | (선택) QA | COMPLETED 후 브라우저 |

## 9/14 닫은 것

| # | 항목 | 근거 |
|---|---|---|
| R-06 | rating USER_NOT_FOUND (캐시-only) | Prisma `users` 조회 · [지시서 09-14](../../reviews/review/teamlead-port-instructions-2026-09-14-r06-user-exists.md) |
...
- UM 공식 `userExists` 포트로 R-06 인라인 조회 교체
