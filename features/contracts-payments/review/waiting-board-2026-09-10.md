...
| 3 | 결제 멱등 — 재시작 후 판정 소실 | `payment_idempotency_records` 테이블은 있음. 런타임은 메모리 `Map` (CR-CP-002 잔여) → CR-CP-003 payload·복합 PK | 팀장 | [CR-CP-003](../change-requests/0003-idempotency-map-to-db.md) |
