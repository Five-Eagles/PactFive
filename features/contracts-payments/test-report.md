...
테스트한 커밋: 커밋 전 (`run.tsx` AGR-01·AGR-02·AGR-03·CTR-01·DLV-01·PAY-01·SET-01·CAN-01 검증 포함)

## 자동 검증

- [x] `npx tsx prototype/run.tsx` 통과 (PASS 개수: 254, FAIL 개수: 0)
...
| 10~13 합의·서명 | 제안·재제안·과거 라운드 대체됨·수락→DRAFT·SIGNING·SIGNED·서명 멱등 | 통과 |
...
| UI(design/web) | AGR·AGR-02·AGR-03 이력·CTR·DLV·PAY·SET·CAN-01. 1280 2열 / 모바일 스택 | 통과 |
