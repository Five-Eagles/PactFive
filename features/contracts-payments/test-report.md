...
| 16 공개 API 경로 | `run.tsx` 「현재 조회」. GET payment 당사자 200 · 비당사자 403 · 없음 404. GET delivery 납품 없음 200 · 비당사자 403 · 없음 404 | 통과 |
| 17 라우트·UX | `run.tsx` 합의 필수 카피·취소 우선·종료 상태 버튼 없음·403/404 금액 숨김. 서명·결제 기존 필수 요소 | 통과 |
