...
- change-requests/: `0001` PM 포트 + **app 호출 배선 완료**(2026-09-11 확인). 트랜잭션 경계는 ADR-0015 R-001.
  `0002` applications 완료 · `app/`·ERD·프로필 포트는 RW 보류(ADR-0014).
  `0003`·`0004` 반영 완료.
...
| 2026-09-20 | R-001 합의 지시서 발행 (팀장 app `$transaction`) · ADR-0015 경계 유지 |
| 2026-09-20 | **R-001 구현** — `ApplicationUnitOfWork`로 create·DIRECT reject 원자화 |
