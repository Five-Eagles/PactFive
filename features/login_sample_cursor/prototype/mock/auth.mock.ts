...
import { assertValidLoginInput, ValidationError } from '../server/auth.validation';
...
export async function mockLogin(input: Partial<LoginInput>): Promise<LoginResponse> {
