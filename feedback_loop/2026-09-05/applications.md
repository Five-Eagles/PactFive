...
**담당자 메모**
- 2026-09-07 유동우 합의(CR-AP-001): 생성 +1/+1 · DIRECT −1만 applications. 수락·마감·취소의
  대기는 PM이 0. `AUTO_*`에서 applications는 빼지 않는다. `features/applications/` Mock에 반영.
  `app/` 쓰기 포트·화면 숫자는 팀장 이식. 검토중.
