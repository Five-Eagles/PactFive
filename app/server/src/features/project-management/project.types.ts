 ...
 *
 * 원본: features/project-management/prototype/server/project.types.ts (3e4977e)
...
export type MyProjectListQuery = Pick<ProjectListQuery, 'recruitmentStatus' | 'page' | 'pageSize'> & {
  transactionStatus?: ProjectTransactionStatus;
};
...
/** 4xx 는 이 오류를 throw 한다. contracts-payments 의 DomainContractError 와 같은 형태다. */
