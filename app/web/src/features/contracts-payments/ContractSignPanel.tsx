 ...
 * 원본: features/contracts-payments/prototype/web/ContractSignPanel.tsx (67207c8)
 */
...
export function ContractSignPanel({
    ...
    return (
      <article className="panel">
        ...
        <p className="status-copy">
          내 서명은 완료되었습니다. <strong>상대방의 서명</strong>을 기다리는 중입니다. 양쪽이
          서명하면 결제로 넘어갑니다.
        </p>
        <dl className="facts">
          <dt>프로젝트 제목</dt>
  ...
  return (
    <article className="panel">
      ...
      <div className="btn-row">
        <Button variant="primary" disabled={submitting} onClick={onSign}>
          서명하기
        </Button>
      </div>
    </article>
